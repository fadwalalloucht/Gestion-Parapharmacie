                            ...
                            <div class="input-group">
                                ...
                                <div class="input-group-append">
                                    <button class="btn btn-sm btn-primary" type="submit"
                                        style="margin-top: -120%; margin-bottom: 14%;">
                                        <i class="ti-search"></i>
                                    </button>
                                </div>
                            </div>
                         ...
                         <%
                            ...
                            try {
                                ...
                                while (res.next()) {
                                    ...
                                    String vmarque = res.getString("marque");
                                    String vfournisseur = res.getString("nom_fournisseur");
                                    String description = res.getString("description");
                                    Double prixAchat = res.getDouble("prix_achat");
                                    Double prixVente = res.getDouble("prix_vente");
                                    int quantite = res.getInt("quantite");
                                    String codeBarre = res.getString("code_barre");
